...
export default function ProjectsSection() {
  ...
  return (
    <section id="projects" className="w-full bg-white text-gray-800 pt-[clamp(8px,1.5vw,24px)] pb-[clamp(48px,8vw,96px)] scroll-mt-20 flex flex-col items-center overflow-x-hidden">
      {/* Section Divider (05) */}
