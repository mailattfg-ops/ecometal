        ...
        <div className="max-w-[1757px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 lg:gap-[113px] items-start pb-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-sm text-white/75 leading-relaxed">
              ...
              <p>WhatsApp: <a href="https://wa.me/918438124471?text=Hi!%20I%20have%20an%20enquiry%20about%20Ecometal%20Matrix." target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">+91 84381 24471</a></p>
