  ...
  return (
    <div className="flex-1 flex flex-col min-h-screen">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-[9999] flex items-center justify-center w-14 h-14 bg-[#25D366] text-white rounded-full shadow-[0_4px_16px_rgba(37,211,102,0.45)] hover:bg-[#20ba5a] hover:scale-110 active:scale-95 hover:shadow-[0_6px_20px_rgba(37,211,102,0.6)] transition-all duration-300 pointer-events-auto select-none"
